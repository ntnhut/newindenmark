...
```{figure} ../images/image_p197_1.jpeg
:alt: Kort over Grønland. Grafik: Albatros.
...
```{figure} ../images/image_p199_1.jpeg
:alt: Billede fra Grønlands hovedstad Nuuk. Foto: Nikolaj Thorborg Lynggaard-Hjort.
...
```{figure} ../images/image_p201_1.jpeg
:alt: Kort over Færøerne. Grafik Albatros.
...
derfor	blev	i	rigsfællesskab	med	Danmark.	Færøerne	fik	hjemmestyre	ved	lov	i	1948. Hjemmestyret består af Lagtinget (en folkevalgt og lovgivende forsamling) 
...
```{figure} ../images/image_p202_1.jpeg
:alt: Udsigt fra bygden Trøllanes på Færøerne. Foto: Tue Schou Pedersen.
