...
man også om miljøbeskyttelse, sociale forhold, beskæftigelse, arbejdsmarked, uddannelse, regional udvikling og udenrigspolitiske spørgsmål. Men der er stor 
...
også	”de	fire	forbehold”.	Aftalen	blev	sendt	ud	til	en	folkeafstemning	året	efter	i 1993.	Denne	gang	stemte	et	flertal	af	danskerne	ja	til	Maastricht-traktaten	med	
...
```{figure} ../images/image_p124_1.jpeg
:alt: Aviser dagen efter, at et flertal af danskerne stemte nej til Maastricht-traktaten i 1992. Foto: Ritzau Scanpix.
...
```{figure} ../images/image_p126_1.jpeg
:alt: Danmarks EU-kommissær Dan Jørgensen til møde med energiministrene fra EU's medlemsstater. Foto: Olivier Hoslet/Ritzau Scanpix.
...
```{figure} ../images/image_p126_2.jpeg
:alt: EU-kommissionens formand Ursula von der Leyen sammen med to tidligere EU-kommissærer: Danske Margrethe Vestager og franske Thierry Breton. Foto: John Thys/Ritzau Scanpix.
...
```{figure} ../images/image_p127_1.jpeg
:alt: Europa-Parlamentet i Bruxelles.
